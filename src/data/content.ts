...
export const whyUs = [
  ...
  {
    title: "जीरो रिस्क शुरुआत",
    body: "पहले काम देखें, फिर तय करें।",
  },
];
...
export const pricingPlans = [
  {
    ...
    desc: "आपके बिज़नेस के लिए सुंदर, सुपर-फ़ास्ट और मोबाइल-फ्रेंडली वेबसाइट",
    now: "₹999",
    was: "₹8,999",
    discount: "90% OFF",
    ...
    features: [
      ...
      "₹399 एडवांस पेमेंट — बिना देरी के काम",
    ],
...
export const faqs = [
  ...
  { q: "Q2", question: "₹999 में कैसी वेबसाइट बनेगी?", answer: "प्रीमियम, मोबाइल-फ्रेंडली  वेबसाइट — WhatsApp बटन, कॉन्टैक्ट फॉर्म, गैलरी और सिक्योरिटी शामिल है। सिर्फ़ डोमेन का सालाना चार्ज (~₹500–₹1200) आपको वहन करना होगा।" },
  ...
  { q: "Q5", question: "कोई एडवांस पेमेंट देना होगा?", answer: "बिल्कुल सिर्फ़ ₹399 पहले वेबसाइट बनाकर दिखाई जाती है, पसंद आने पर ही ₹999 का भुगतान लिया जाता है।" },
];
