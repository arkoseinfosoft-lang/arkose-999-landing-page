...
export default function MobileBar() {
  return (
    <div
      className="fixed inset-x-0 bottom-0 z-[999] w-full max-w-[100vw] border-t border-paper-line bg-paper/96 px-4 py-2.5 pb-[calc(10px+env(safe-area-inset-bottom,0px))] shadow-[0_-8px_24px_rgba(140,32,21,0.12)] backdrop-blur-md sm:hidden"
