  ...
  return (
    <section className="section">
      <div className="mx-auto max-w-[1120px] px-4">
        <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-[1.1fr_.9fr] md:gap-12">
          <Reveal direction="left">
            <span className="mb-2.5 block font-serif-hi text-[13px] font-bold tracking-wide text-red-deep">
              कोई बड़ा एडवांस पेमेंट नहीं
            </span>
            <h2 className="mb-4 font-serif-hi text-[clamp(24px,3.5vw,36px)] font-bold leading-[1.3] text-ink">
          ...
          <Reveal
            direction="right"
            className="border border-paper-line bg-card p-6 shadow-[0_20px_44px_rgba(140,32,21,0.08)] sm:p-7"
          >
            <form onSubmit={submit}>
              ...
              <input
                ...
                className="mb-4.5 w-full rounded border border-paper-line bg-paper px-3.5 py-3 text-[14.5px] text-ink placeholder:text-[#a89a7a] focus:outline-none focus:ring-2 focus:ring-gold"
              />
              ...
              <input
                ...
                className="mb-6 w-full rounded border border-paper-line bg-paper px-3.5 py-3 text-[14.5px] text-ink placeholder:text-[#a89a7a] focus:outline-none focus:ring-2 focus:ring-gold"
              />
              <motion.button
                whileHover={{ y: -2 }}
                whileTap={{ y: 2 }}
                type="submit"
                className="w-full rounded bg-red px-6 py-4 text-[15.5px] font-bold text-white shadow-[0_3px_0_var(--color-red-deep)]"
              >
